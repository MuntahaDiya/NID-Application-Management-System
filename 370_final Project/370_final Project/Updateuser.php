...
<html lang="en">
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
			<div class="col-md-2" style="font-size: 30px;color:#F2674A;"> NID card Applicant Management System </div>
	...
	<section id = "section1">
		<div class="title"> Update Applicant Info </div>
		
		<form action="u.php" class="form_design" method="post">
